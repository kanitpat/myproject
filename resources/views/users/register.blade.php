...
<div class="login-block" >
	...
	<div class="row">
		<div class="col-md-4 login-sec">
		    ...
		    <form class="login-form" action="{{url('users')}}" method = "POST" >
            {{csrf_field()}}
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Enter Name" name="lastName" value = "{{old('lastName')}}" required >
...
<h1><div class="copy-text"> <a href="{{url('login')}}">Login</a></div><h1>
		</div>
